...
def load_data():
    ...
    os.environ["DESTINATION__CREDENTIALS"]= Variable.get("bigquery_credentials") # env for private key, env for project id, env for client email 
    ...
    pipeline = dlt.pipeline(pipeline_name='pipeline_name',
                     dataset_name='airflow_github_data_test', # change dataset name

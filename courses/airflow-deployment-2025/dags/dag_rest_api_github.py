...
def load_data():
    ...
    os.environ["REST_API_GITHUB__DESTINATION__BIGQUERY__CREDENTIALS__PROJECT_ID"] = Variable.get("bigquery_project_id")
    os.environ["REST_API_GITHUB__DESTINATION__BIGQUERY__CREDENTIALS__CLIENT_EMAIL"] = Variable.get("bigquery_client_email")

...
def load_data_parallel():
    ...
    os.environ["REST_API_GITHUB_PARALLEL__DESTINATION__BIGQUERY__CREDENTIALS__PROJECT_ID"] = Variable.get("bigquery_project_id")
    os.environ["REST_API_GITHUB_PARALLEL__DESTINATION__BIGQUERY__CREDENTIALS__CLIENT_EMAIL"] = Variable.get("bigquery_client_email")
    ...
    os.environ["REST_API_GITHUB_PARALLEL__DESTINATION__BIGQUERY__CREDENTIALS__PRIVATE_KEY"] = private_key
    ...
    # Import the source function from github_pipeline.py
    from github_pipeline import github_source

    # modify the pipeline parameters 
    pipeline = dlt.pipeline(
        pipeline_name='rest_api_github_parallel',
        dataset_name='github_dataset_parallel',

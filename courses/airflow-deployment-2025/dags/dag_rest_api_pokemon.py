...
def load_data():
    ...
    # create the source without decomposition first to avoid recursion issues
    tasks.add_run(
        pipeline,
        pokemon_source,
...
# restart if needed: pkill -f "airflow webserver", pkill -f "airflow scheduler"

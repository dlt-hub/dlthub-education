...
def make_resource_asset(resource_name: str):
    @dlt_assets(
        dlt_source=github_source.with_resources(resource_name), # use the correct source 
...
dagster_github_assets_parallel = [make_resource_asset(resource) for resource in resource_names]
